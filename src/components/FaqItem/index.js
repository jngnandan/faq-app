        ...
        return (
            <div className='w-96 py-6 px-4 border-2 border-gray-300 rounded-xl m-4' >
                <div className="flex flex-row justify-between">
                    ...
                    {!value ? <button value={id} onClick={toggle}><img src="https://assets.ccbp.in/frontend/react-js/faqs-plus-icon-img.png" /></button> :
                        <button value={id} onClick={toggle}><img src="https://assets.ccbp.in/frontend/react-js/faqs-minus-icon-img.png" /></button>}
                </div>
